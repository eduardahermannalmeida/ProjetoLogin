...
public class FrSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(188, 137, 167));

        jLabel1.setFont(new java.awt.Font("Gill Sans MT Condensed", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(97, 59, 74));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Sobre o Sistema");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/ulbra/img/LoginLogo.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Gill Sans MT Condensed", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(97, 59, 74));
        jLabel3.setText("Desenvolvido por:");

        jLabel4.setFont(new java.awt.Font("Ink Free", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(97, 59, 74));
        jLabel4.setText("Eduarda Hermann de Almeida");

        btnSair.setBackground(new java.awt.Color(255, 204, 204));
        btnSair.setFont(new java.awt.Font("Gill Sans MT Condensed", 3, 14)); // NOI18N
        ...
        jLabel5.setFont(new java.awt.Font("Gill Sans MT Condensed", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(97, 59, 74));
